# Group Detector Using YOLOv5_StrongSORT_OSNET (221024 DK)


## Introduction

Part of our code is borrowed from [Yolov5_DeepSort_Pytorch](https://github.com/mikel-brostrom/Yolov5_StrongSORT_OSNet).

Download [weights](https://drive.google.com/drive/folders/1QyztUnT8oxZXid_K0UQIHuvg1UUw5vs1?usp=sharing) to `./weights` folder.
